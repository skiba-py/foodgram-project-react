...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('name', 'measurement_unit'), name='поле уникально для игредиента'),
        ),
        migrations.AddConstraint(
            model_name='ingredient',
        ...
        migrations.AddField(
            model_name='carts',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='in_carts', to='recipes.recipe', verbose_name='Рецепты в списке'),
        ),
        migrations.AddField(
            model_name='carts',
            name='user',
        ...
        migrations.AddField(
            model_name='amountingredient',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient', to='recipes.recipe', verbose_name='Указывает на рецепты'),
        ),
        migrations.AddConstraint(
            model_name='recipe',
